...
namespace SpicyBukka.Areas.Admin.Controllers
{
    ...
    public class SubCategoryController : Controller
    {
        ...
        [TempData]
        public string StatusMessageforTransmission { get; set; }
        ...
        public async Task<IActionResult> Create(SubCategoryAndCategoryViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    //Error
                    StatusMessageforTransmission = "Error : Sub Category exists under " + doesSubCategoryExists.First().Category.Name + " category. Please use another name.";
                }
            ...
            SubCategoryAndCategoryViewModel modelVm = new SubCategoryAndCategoryViewModel()
            {
                ...
                StatusMessage = StatusMessageforTransmission
